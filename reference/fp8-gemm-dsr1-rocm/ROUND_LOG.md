...
**Result:** 137.7 µs / 873 TFLOP/s — **WIN, 1.76× over v2 (242.9 µs)**
...
**Result:** 101.6 µs / 1184 TFLOP/s — **WIN, 1.35× over v6**
...
**Result:** 109.8 µs / 1095 TFLOP/s — **DEAD-END, 8% slower than v7**
...
|------:|---------|--------|---:|--------:|-------------|
| 1 | v6_lds_swizzle | WIN | 137.7 | 873 | 8-byte row pad eliminates 8-way LDS bank conflicts — dominant bottleneck |
| 2 | v7_8wave | WIN (ANCHOR) | 101.6 | 1184 | 8 waves/block → 24 waves/CU fully hides 64-cycle MFMA latency |
| 3 | v8_wider_n | DEAD-END | 109.8 | 1095 | BN=256 → 2 blocks/CU → 16 waves/CU → at MFMA latency threshold |
